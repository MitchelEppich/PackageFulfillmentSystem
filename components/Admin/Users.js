...
import { faAngleLeft, faTimes, faLock, faUserAlt, faUnlockAlt, faUserAltSlash } from "@fortawesome/free-solid-svg-icons";
    ...
    for (let user of props.user.registeredUsers) {
      arr.push(
        <div className="w-full inline-flex p-2 mt-1 bg-white flex items-center">
          ...
          <div className="w-1/8 pl-4 capitalize">{user.online ? (          
                <div style={{
                    borderRadius: "50%", 
                    width: "20px",
                    height: "20px", 
